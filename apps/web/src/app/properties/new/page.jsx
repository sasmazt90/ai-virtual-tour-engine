...
import { PhotoUploadSection } from "@/components/PropertyForm/PhotoUploadSection";

export default function NewPropertyPage() {
  const { data: user, loading: userLoading } = useUser();
  const [upload, { loading: uploading }] = useUpload();

  const formState = useNewPropertyForm({ user, upload });
  ...
  const disableSubmit = formState.submitting || uploading;
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 font-jetbrains-mono">
              Create a listing with full property details.
            </p>
          </div>
          ...
          <form onSubmit={formState.onSubmit} className="space-y-8">
            ...
            <PhotoUploadSection
              onPickPhotos={formState.onPickPhotos}
