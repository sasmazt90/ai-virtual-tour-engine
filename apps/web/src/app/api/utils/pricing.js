...
export const AI_VIDEO_3D_MAX_MB = null;
export const AI_VIDEO_3D_MAX_BYTES = Number.POSITIVE_INFINITY;
...
export const AI_VIDEO_3D_CREDIT_TIERS = [
  ...
  { maxBytes: AI_VIDEO_3D_MAX_BYTES, credits: 800, label: "500 MB+" },
];
